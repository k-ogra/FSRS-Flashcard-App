...
import { getPublicDecks, copyDeck, ApiError } from "../../api";
    ...
    return (
      <div className="decks-page">
        <div className="decks-inner">
          <p className="decks-loading">Loading public decks...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="decks-page">
      <div className="decks-inner">
        <div className="decks-header">
          <h1 className="decks-heading">Public Decks</h1>
          <p className="decks-sub">
            {decks.length === 0
              ? "Browse decks shared by the community."
        ...
        {decks.length === 0 ? (
          <div className="decks-empty">
            ...
            <h2 className="decks-empty-heading">No public decks yet</h2>
